...
const Servers = () => {
    return (
        <Section>
            <MainTitle text="Administración de servidores GNU/Linux y windows" />
  ...
  <div className="content">
    ...
    <div className="service-text">
      <h2>Administración de Servidores GNU/Linux y Windows</h2>
      <p>En IKA contamos con una amplia experiencia en la administración, instalación y configuración de servidores GNU/Linux y Windows, tanto físicos como virtuales.</p>
      ...
      <ul>
        ...
        <li>Monitoreo de recursos y rendimiento de sistemas en tiempo real como Zabbix, Nagios y Cacti.</li>
        <li>Implementación de backups automáticos y recuperación ante fallos.</li>
        <li>Accesos remotos seguros con autenticación y cifrado como VPN.</li>
        <li>Soporte en virtualización con tecnologías como Proxmox, AWS, Huawei Cloud.</li>
      </ul>
